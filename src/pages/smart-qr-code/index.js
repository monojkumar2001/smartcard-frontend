...
function SmartQrCodePage() {
  ...
  const renderPreviewIcons = () => {
    return previewIcons.map((socialPlatform, index) => (
      <div key={index} className="preview-icon-item">
        <img
          src={
            DataIcons.find((item) => item.name.toLowerCase() === socialPlatform)
              ?.img
          }
          alt={socialPlatform}
        />
  ...
  const inputAreaHandler = (e) => {
    ...
    setErrorsArea((prev) => ({
      ...prev,
      summary: value.length > 250 ? "Description exceeds 250 characters." : "",
    }));
  };
  return (
    <AppLayout>
              ...
              <div className="row">
                <div className="col-lg-8 mb-4">
                  <div className="mb-3  d-flex align-items-center gap-4">
                    ...
                    <div className="product-input w-100">
                      ...
                      />
                      <InputError messages={errors.cardname} className="mt-2" />
                    </div>
                  </div>
                  ...
                  <div className="form-group-wrapper mt-3">
                    ...
                    >
                      <p>Design and customize your Smart Card</p>
                      <div className="bottom-arrow">
                        <img src="/img/icons/bottom-arrow.svg" alt="" />
                      </div>
                    </div>

                    <div className="color-plate collapse show" id="colorPicker">
                      <p>Personalize your Smart Card by selecting colors.</p>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-3">
                          ...
                          <div className="pic-with-color">
                            <p>{secondaryColorScheme}</p>
                            <input
                              type="color"
                              className=" form-control-color"
                              id="primarycolor"
                              value={secondaryColorScheme}
                              onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="mb-3">
                                <input
                                  ...
                                  className="form-control"
                                  onChange={inputsHandler}
                                  value={inputField.phone1}
                                  placeholder="Phone"
                                />
                                <InputError
                                  messages={errors.phone1}
                                  className="mt-2"
                                />
                              </div>
                            </div>
                        ...
                        <div className="col-md-10">
                          <div className="mb-3">
                            <input
                              ...
                              name="webaddress2"
                              onChange={inputsHandler}
                              value={inputField.webaddress2}
                            />
                            <InputError
                              messages={errors.webaddress2}
                              className="mt-2"
                            />
                          </div>
                        </div>
                          ...
                          <div className="social-all-item">
                            {DataIcons.map((item) => (
                              <div
                                ...
                                key={item.id}
                                onClick={() =>
                                  addInputField(item.name.toLowerCase())
                                }
                              >
                  ...
                  <div className="form-group-wrapper mt-3">
                    ...
                    <div className="color-plate collapse show" id="welScreen">
                      <p className="mb-3">
                        Display your logo while your page is loading: (Max Image
                        Size 300*300)
                      </p>
                  ...
                  <div className="form-group-wrapper mt-3">
                    ...
                    <div className="color-plate collapse" id="shareItem">
                      <div className="row">
                        <div className="col-md-2">
                          <div className="info-form-label">
                            <p>Sharing:</p>
                ...
                <div className="col-lg-4 mb-4">
                  <div className="preview">
                    ...
                    >
                      <div className="my-preview-top-header" style={divStyle}>
                        ...
                        <p className="dajignation">{inputField.jobTitle}</p>

                        <ul className="social-aciton-right">
                          <li>
                            <a href={`tel:${inputField.mobile1}`}>
                              <img src="/img/icon/call.svg" alt="" />
                              <p>Call</p>
                            </a>
                          </li>
                          <li>
                            <a href={`mailto:${inputField.email1}`}>
                              <img src="/img/icon/telegram2.svg" alt="" />
                              <p>Email</p>
                            </a>
                          </li>
                          {/* <li>
                      ...
                      <div className="card-list-right">
                        <ul>
                          ...
                          <li className="card-list-li">
                            <div className="preview-info-icon">
                              <img src="/img/icon/toffee.svg" alt="" />
                            </div>
                            <div className="info-show">
                              <p>Company Name</p>
                              <a href={inputField.webaddress2}>
                    ...
                    >
                      ...
                      <div className="card-list-right text-center">
                        ...
                        <p>
                          You can customize the design of your QR Code in the
                          next step.
                        </p>
                      </div>
                    </div>
...
SmartQrCodePage.layout = AppLayout;
