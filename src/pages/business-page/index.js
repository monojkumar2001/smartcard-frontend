...
function BusinesPage() {
    ...
    // ===== Step ===========
    const totalSteps = 6; // Set the total number of steps
                        ...
                        <div className="row">
                            <div className="col-lg-8 mb-4">
                                <div className="step-progress-bar">
                                    <div className="step-progress-bar-item" style={{ width: `${calculateProgress()}%` }}></div>
                                </div>
                                {currentStep === 1 && (
                                    <>
                                        ...
                                        <div className="form-group-wrapper mt-3">
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <ImageUploader handleCrop={handleCrop} croppedImage={croppedImage} />
                                ...
                                <div className="step-btn-item">
                                    {currentStep > 1 && (
                                        <button onClick={prevStep} className="custom-btn">
                                            <span>Previous</span>
                                        </button>
                                    )}
                                    {currentStep < 6 ? (
                                        <button onClick={nextStep} className="custom-btn">
                                            <span>{currentStep === 6 ? 'Confirm' : 'Next'}</span>
                                        </button>
                                    ) : (
