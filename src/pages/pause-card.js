        ...
        <div className="dashboard-content-wrapper">
                <div className="qr-show">
                    <div className="qr-nav">
                        ...
                        <div className="qr-create-button">
                            <button className="custom-btn" onClick={handleQrModel}>
                                <span>  Create New Smart
                                    Card</span>
                            </button>
                    ...
                    <ul className="qe-ul">
                        <li >
                            <div className="qr-list-item">
                                <div className="qr-list-item-left">
                                ...
                                <div className="qr-list-item-right">
...
PauseCardPage.layout = DashboardLayout;
export default PauseCardPage